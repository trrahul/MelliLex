...
export const api = {
  ...
  async generatePracticeExercisesOnly(word: string, count: number, force = false): Promise<{
  ...
  async generateCommonMistakes(word: string, force = false): Promise<import('../types').MistakeItem[]> {
